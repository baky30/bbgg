...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '3703ca629f6cf11fc7cc4a0bcff2b1c8',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  project_uuid: 'f9d4a487-6a73-4d99-91c2-60dffe2755db',
  flHost:
...
config.pexelsQuery = 'abstract gears and cogs';
config.host =
